...
fontC = ImageFont.truetype('carplate_recog/platech.ttf', 32, 0)
...
class detector(object):
    ...
    def __init__(self):
        ...
        self.class_name_path = 'carplate_recog/data/mydata.names'
    ...
    def init_params(self):
        ...
        self.yolo_model = yolov3(self.num_class, anchors)
    ...
    def detect(self, img_ori):
        ...
        for i in range(len(boxes_)):
            ...
            results.append((float(scores_[0]),res))
