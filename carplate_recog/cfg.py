...
restore_path = 'carplate_recog/data/darknet_weights/yolov3.ckpt'  # The path of the weights to restore.
save_dir = 'checkpoint/'  # The directory of the weights to save.
anchor_path = 'carplate_recog/data/yolo_anchors.txt'  # The path of the anchor txt file.
class_name_path = 'carplate_recog/data/mydata.names'  # The path of the class names.
